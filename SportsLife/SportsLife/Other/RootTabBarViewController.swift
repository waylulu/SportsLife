...
class RootTabBarViewController: UITabBarController {
    ...
    var viewControllerArr = [SportsTableViewController(),ShopCollectionViewController(),GamesTableViewController(),MineTableViewController()]
    var titleArr = ["体育","购物","游戏","个人中心"]
    ...
    func configUI() {
        ...
        let three = self.setController(viewController: GamesTableViewController())
...
//        na.tabBarItem.setTitleTextAttributes(NSDictionary.init(object:defaultColor, forKey: NSAttributedStringKey.backgroundColor as NSCopying) as? [NSAttributedStringKey : Any], for: UIControlState.normal)
//        na.tabBarItem.setTitleTextAttributes(NSDictionary.init(object:selectColor, forKey: NSAttributedStringKey.backgroundColor as NSCopying) as? [NSAttributedStringKey : Any], for: UIControlState.selected)
//
